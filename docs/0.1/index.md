...
The Entity Metadata Management API is intended to establish a consistent pattern that supports [Entity Metadata Providers](#terminology) sharing changes to curated entities and their metadata with the community of [Entity Metadata Consumers](#terminology) (e.g. libraries, museums, archives). Use of a consistent pattern allows for the creation of software tools for producing and consuming changes in entity metadata.
