...
[emm-change-api-example-notifications]: {{ site.url }}{{ site.baseurl }}/examples/my-collection/notifications/entry-point.json "EMM API Notifications Example"
[emm-change-api-example-partialcache]: {{ site.url }}{{ site.baseurl }}/examples/my-collection/partial-cache/entry-point.json "EMM API Label Change Patches Example"
[emm-change-api-example-fullcache]: {{ site.url }}{{ site.baseurl }}/examples/my-collection/full-cache/entry-point.json "EMM API Full Patch Incremental Updates Example"
